...
NAME="human_aftercare"                                  # Name of the application
ROOTDIR=/opt/webapps
...
DJANGO_SETTINGS_MODULE=human_aftercare.settings.main             # which settings file should Django use
DJANGO_WSGI_MODULE=human_aftercare.wsgi                     # WSGI module name
...
export PYTHONPATH=${DJANGODIR}/human_aftercare:${PYTHONPATH}
